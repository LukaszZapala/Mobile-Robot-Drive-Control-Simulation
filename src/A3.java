			...
			public void action() 
			{
				...
				do
				{
					...
					if (msg != null)
					{
						...
						{
							System.out.println("A3: Odebrano komunikat " + msg.getContent());
			...
			public void action() 
			{
				...
				if (msg != null)
				{
					...
					if ("Agent0".equals(msg.getSender().getLocalName()))
					{
						...
						if ("MOVE UP".equals(msg.getContent()) || "TURN LEFT".equals(msg.getContent())) state = 1;
						else if ("MOVE DOWN".equals(msg.getContent()) || "TURN RIGHT".equals(msg.getContent())) state = -1;
						else state = 0; 
					}
				...
				else
				{
					...
					{
						standby = true;
						System.out.println("A3: Czekam na polecenie!");
					}
				}
			}
